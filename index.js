...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// the nestedFunction is within the same function as the variable "internal" and therefore within the same scope.
...
console.log(lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop = array.filter((element) => {
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((accumulator, currentVal) => {
...
const newCuboid = new CuboidMaker({length: 3, width: 3, height: 4});
